...
//========================================//
bool Timer::initEpoll()
{
	const int epoll_size = 32; //-- Since Linux 2.6.8, the size argument is ignored, but must be greater than zero.
...
{
	int _waitMilliseconds = Timer_defaultWaitMsec;
