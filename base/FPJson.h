...
private:
	...
	//JsonPtr getNode(const std::string& path, const std::string& delim);  //-- see get members part.
...
public:
	...
	Json& operator = (unsigned short value)     { setInt(value); return *this; }
	Json& operator = (int value)                { setInt(value); return *this; }
	Json& operator = (unsigned int value)       { setInt(value); return *this; }
	Json& operator = (long value)               { setInt(value); return *this; }
	Json& operator = (unsigned long value)      { setInt(value); return *this; }
	Json& operator = (long long value)          { setInt(value); return *this; }
	Json& operator = (unsigned long long value) { setInt(value); return *this; }
	...
	bool push(unsigned short value)           { return pushInt(value); }
	bool push(int value)                      { return pushInt(value); }
	bool push(unsigned int value)             { return pushInt(value); }
	bool push(long value)                     { return pushInt(value); }
	bool push(unsigned long value)            { return pushInt(value); }
	bool push(long long value)                { return pushInt(value); }
	bool push(unsigned long long value)       { return pushInt(value); }
	...
	void push(const std::string& path, unsigned short value, const std::string& delim = "./")     { pushInt(path, value, delim); }
	void push(const std::string& path, int value, const std::string& delim = "./")                { pushInt(path, value, delim); }
	void push(const std::string& path, unsigned int value, const std::string& delim = "./")       { pushInt(path, value, delim); }
	void push(const std::string& path, long value, const std::string& delim = "./")               { pushInt(path, value, delim); }
	void push(const std::string& path, unsigned long value, const std::string& delim = "./")      { pushInt(path, value, delim); }
	void push(const std::string& path, long long value, const std::string& delim = "./")          { pushInt(path, value, delim); }
	void push(const std::string& path, unsigned long long value, const std::string& delim = "./") { pushInt(path, value, delim); }
	...
	void add(const std::string& path, unsigned short value, const std::string& delim = "./")        { addInt(path, value, delim); }
	void add(const std::string& path, int value, const std::string& delim = "./")                   { addInt(path, value, delim); }
	void add(const std::string& path, unsigned int value, const std::string& delim = "./")          { addInt(path, value, delim); }
	void add(const std::string& path, long value, const std::string& delim = "./")                  { addInt(path, value, delim); }
	void add(const std::string& path, unsigned long value, const std::string& delim = "./")         { addInt(path, value, delim); }
	void add(const std::string& path, long long value, const std::string& delim = "./")             { addInt(path, value, delim); }
	void add(const std::string& path, unsigned long long value, const std::string& delim = "./")    { addInt(path, value, delim); }
	...
	operator unsigned int() const throw(FpnnJsonNodeTypeMissMatchError)       { return (unsigned int)      wantInt(); }
	operator long() const throw(FpnnJsonNodeTypeMissMatchError)               { return (long)              wantInt(); }
	operator unsigned long() const throw(FpnnJsonNodeTypeMissMatchError)      { return (unsigned long)     wantInt(); }
	operator long long() const throw(FpnnJsonNodeTypeMissMatchError)          { return (long long)         wantInt(); }
	operator unsigned long long() const throw(FpnnJsonNodeTypeMissMatchError) { return (unsigned long long)wantInt(); }
